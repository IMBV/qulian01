package com.quliantrip.qulian.ui.widget;
...
/**
 * Created by Yuly on 2015/12/24.
 * www.quliantrip.com
 */
public class EmptyLayoutAll extends LinearLayout implements
    ...
    public EmptyLayoutAll(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public EmptyLayoutAll(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
