...
public class SortChildAdapter extends BaseAdapter {
	...
	Context mContext;
	List<TuanBean.BcateListEntity.BcateTypeEntity> mChildArr;// 子item标题数组
	 ...
	 * @param context
	 */
	public SortChildAdapter(Context context) {
		mContext = context;
	}
	 ...
	 * @param childArr
	 */
	public void setChildData(List<TuanBean.BcateListEntity.BcateTypeEntity> childArr) {
